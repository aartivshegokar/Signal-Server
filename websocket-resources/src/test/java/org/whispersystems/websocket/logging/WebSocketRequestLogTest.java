...
public class WebSocketRequestLogTest {
  ...
  public void testLogLineWithoutHeaders() throws InterruptedException {
    ...
    String loggedLine = new String(listAppender.outputStream.toByteArray()).trim();
    assertThat(loggedLine.matches("123\\.456\\.789\\.123 \\- \\- \\[[0-9]{2}\\/[a-zA-Z]{3}\\/[0-9]{4}:[0-9]{2}:[0-9]{2}:[0-9]{2} [\\\\-\\\\+]{1}[0-9]{4}\\] \"GET \\/v1\\/test WS\" 200 \\- \"\\-\" \"\\-\"")).isTrue();
  }
  ...
  public void testLogLineWithHeaders() throws InterruptedException {
    ...
    String loggedLine = new String(listAppender.outputStream.toByteArray()).trim();
    assertThat(loggedLine.matches("123\\.456\\.789\\.123 \\- \\- \\[[0-9]{2}\\/[a-zA-Z]{3}\\/[0-9]{4}:[0-9]{2}:[0-9]{2}:[0-9]{2} [\\\\-\\\\+]{1}[0-9]{4}\\] \"GET \\/v1\\/test WS\" 200 \\- \"https://moxie.org\" \"SmertZeSmert\"")).isTrue();
